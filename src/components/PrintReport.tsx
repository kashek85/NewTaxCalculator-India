...
export const PrintReport: React.FC<PrintReportProps> = ({ inputs, result }) => {
  ...
  const annualRentPaid = dedHra > 0 ? dedHra + (0.10 * annualBasic) : actualHRA * 1.2 * 12;
  ...
  return (
    <div className="print-report-container">
      ...
      {/* Page 1: Summary */}
      <div className="pdf-page-sheet print-sheet" id="print-page-1">
      ...
      {/* Page 2: Strategy */}
      <div className="pdf-page-sheet print-sheet" id="print-page-2">
        <div className="pdf-header">
          <span className="doc-code">TAXOPTIMA PREMIUM REPORT</span>
      ...
      {/* Page 3: Investments */}
      <div className="pdf-page-sheet print-sheet" id="print-page-3">
        <div className="pdf-header">
          <span className="doc-code">TAXOPTIMA PREMIUM REPORT</span>
      ...
      {/* Page 4: Checklist */}
      <div className="pdf-page-sheet print-sheet" id="print-page-4">
        <div className="pdf-header">
          <span className="doc-code">TAXOPTIMA PREMIUM REPORT</span>
      ...
      {/* Page 5: CA Sheet */}
      <div className="pdf-page-sheet print-sheet" id="print-page-5">
        <div className="pdf-header">
          <span className="doc-code">TAXOPTIMA PREMIUM REPORT</span>
